...
/// everything.
pub const FOMOXA_SCHEMA_FINGERPRINT: u64 = 0x9622E96B1C562C0C;

/// `DeviceState`, as declared - every annotated field, whatever codec it joined.
pub const DEVICE_STATE_FINGERPRINT: u64 = 0x509323305EDEF242;
/// `DeviceState.edge` - the wire contract `DeviceStateEdgeCodec` encodes and decodes.
pub const DEVICE_STATE_EDGE_MESSAGE_ID: u32 = 0x2796F8AC;
pub const DEVICE_STATE_EDGE_FINGERPRINT: u64 = 0x4625CB8E64B0827A;
...
pub const DEVICE_STATE_UNITY_MESSAGE_ID: u32 = 0x9AF41CDE;
pub const DEVICE_STATE_UNITY_FINGERPRINT: u64 = 0x4811419F2DA07DFE;
...
pub const EVERY_PRIMITIVE_FINGERPRINT: u64 = 0xCF954A74F95A1DE7;
/// `EveryPrimitive.edge` - the wire contract `EveryPrimitiveEdgeCodec` encodes and decodes.
pub const EVERY_PRIMITIVE_EDGE_MESSAGE_ID: u32 = 0x19FCABFF;
pub const EVERY_PRIMITIVE_EDGE_FINGERPRINT: u64 = 0x2EC0C98895E5A4E1;
...
pub const PLAYER_INFO_FINGERPRINT: u64 = 0x16C91CAB6596E852;
/// `PlayerInfo.edge` - the wire contract `PlayerInfoEdgeCodec` encodes and decodes.
pub const PLAYER_INFO_EDGE_MESSAGE_ID: u32 = 0xC396A399;
pub const PLAYER_INFO_EDGE_FINGERPRINT: u64 = 0xB87A1C88C5B6E0DD;
...
pub const TEAM_FINGERPRINT: u64 = 0x75660C480FC1252F;
/// `Team.edge` - the wire contract `TeamEdgeCodec` encodes and decodes.
pub const TEAM_EDGE_MESSAGE_ID: u32 = 0x7AEF5FF1;
pub const TEAM_EDGE_FINGERPRINT: u64 = 0xF79FA59BF3400D19;
...
pub const TELEMETRY_FINGERPRINT: u64 = 0xF61CBFAE4B8D1F0B;
/// `Telemetry.edge` - the wire contract `TelemetryEdgeCodec` encodes and decodes.
pub const TELEMETRY_EDGE_MESSAGE_ID: u32 = 0x2EBD5DCD;
pub const TELEMETRY_EDGE_FINGERPRINT: u64 = 0x6C195D481F875B06;
...
pub const TELEMETRY_ORANGE_PI_MESSAGE_ID: u32 = 0x451F06EE;
pub const TELEMETRY_ORANGE_PI_FINGERPRINT: u64 = 0x795E4AAF9379B5FE;
...
pub const FOMOXA_MESSAGES: &[FomoxaMessage] = &[
    FomoxaMessage { id: EVERY_PRIMITIVE_EDGE_MESSAGE_ID, name: "EveryPrimitive.edge", fingerprint: EVERY_PRIMITIVE_EDGE_FINGERPRINT, prefixes: EVERY_PRIMITIVE_EDGE_PREFIXES },
    FomoxaMessage { id: DEVICE_STATE_EDGE_MESSAGE_ID, name: "DeviceState.edge", fingerprint: DEVICE_STATE_EDGE_FINGERPRINT, prefixes: DEVICE_STATE_EDGE_PREFIXES },
    FomoxaMessage { id: TELEMETRY_EDGE_MESSAGE_ID, name: "Telemetry.edge", fingerprint: TELEMETRY_EDGE_FINGERPRINT, prefixes: TELEMETRY_EDGE_PREFIXES },
    FomoxaMessage { id: TELEMETRY_ORANGE_PI_MESSAGE_ID, name: "Telemetry.orange_pi", fingerprint: TELEMETRY_ORANGE_PI_FINGERPRINT, prefixes: TELEMETRY_ORANGE_PI_PREFIXES },
    FomoxaMessage { id: PLAYER_EDGE_MESSAGE_ID, name: "Player.edge", fingerprint: PLAYER_EDGE_FINGERPRINT, prefixes: PLAYER_EDGE_PREFIXES },
    FomoxaMessage { id: TEAM_EDGE_MESSAGE_ID, name: "Team.edge", fingerprint: TEAM_EDGE_FINGERPRINT, prefixes: TEAM_EDGE_PREFIXES },
    FomoxaMessage { id: DEVICE_STATE_UNITY_MESSAGE_ID, name: "DeviceState.unity", fingerprint: DEVICE_STATE_UNITY_FINGERPRINT, prefixes: DEVICE_STATE_UNITY_PREFIXES },
    FomoxaMessage { id: PLAYER_INFO_EDGE_MESSAGE_ID, name: "PlayerInfo.edge", fingerprint: PLAYER_INFO_EDGE_FINGERPRINT, prefixes: PLAYER_INFO_EDGE_PREFIXES },
];
