...
/// everything.
inline constexpr std::uint64_t FOMOXA_SCHEMA_FINGERPRINT = 0x34446BE035271024ULL;

/// `Player`, as declared - every annotated field, whatever codec it joined.
inline constexpr std::uint64_t PLAYER_FINGERPRINT = 0x43F94578898A5992ULL;
...
inline constexpr std::uint32_t PLAYER_UNITY_MESSAGE_ID = 0x48AE5CB2u;
inline constexpr std::uint64_t PLAYER_UNITY_FINGERPRINT = 0x3A09927A6D1A81F1ULL;
...
inline const std::vector<FomoxaMessage> FOMOXA_MESSAGES = {
    FomoxaMessage{PLAYER_UNITY_MESSAGE_ID, "Player.unity", PLAYER_UNITY_FINGERPRINT, PLAYER_UNITY_PREFIXES, PLAYER_UNITY_PREFIX_COUNT},
